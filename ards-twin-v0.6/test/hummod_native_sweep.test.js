...
function valid(){return {schema:'vent-hummod-native-sweep/v1',id:'s',clinicalValidation:false,baseline:{assignments:{'Ventilator.Switch':1,'Ventilator.Rate':16,'Ventilator.TidalVolume':450,'AirSupply-GasTanks.Switch':1,'AirSupply-GasTanks.O2Valve(%)':50,'AirSupply-GasTanks.N2Valve(%)':50,'AirSupply-GasTanks.CO2Valve(%)':0,'AirSupply-GasTanks.COValve(PPM)':0,'AirSupply-GasTanks.AnestheticValve(%)':0}},cases:[{id:'water',mechanism:'water',assignments:{'Ventilator.Switch':1,'Ventilator.Rate':16,'Ventilator.TidalVolume':450,'ExcessLungWater.Volume':250}}],provenance:{berlinArdsCalibration:false}};}
