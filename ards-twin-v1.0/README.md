...
This v1.0 package promotes the full deployable Vent + live reduced HumMod clinical twin, including the oxygen-debt decompensation controller, acidemia myocardial depression, progressive shock/collapse staging, and terminal PEA arrest behavior. The primary experience is a persistent synthetic aspiration ARDS reference patient: change the ventilator, advance time, perform holds/mechanics measurements, and observe mechanical, gas-exchange, and hemodynamic responses without resetting the patient.
