// HISTORICAL v0.4.2 bundle — preserved for reference. The current release bundle is ards-v044.bundle.js (v0.4.4.1, mechanical-construct preset labels).
...
// ards-twin-v0.4/src/clock.js
var require_clock = __commonJS({
  "ards-twin-v0.4/src/clock.js"(exports, module) {
...
// ards-twin-v0.4/src/compartments.js
var require_compartments = __commonJS({
  "ards-twin-v0.4/src/compartments.js"(exports, module) {
    var EPS_CAP = 1e-9;
...
// ards-twin-v0.4/src/recruitment.js
var require_recruitment = __commonJS({
  "ards-twin-v0.4/src/recruitment.js"(exports, module) {
    var EPS_CAP = 1e-9;
    var OPEN_DEFAULT = 25;
...
// ards-twin-v0.4/src/mechanics.js
var require_mechanics = __commonJS({
  "ards-twin-v0.4/src/mechanics.js"(exports, module) {
    var {
      availabilityFor,
      elasticPressure,
      elasticPressureAboveAOP,
      ...
      for (let i = 0; i < N; i++) {
        ...
        if (vNew < FLOW_ZERO_TOL) {
          ...
          const pElPlus = elasticPressureAboveAOP(
            Math.min(vTiny + epsV, vmax * (1 - 2 * EPS_CAP)),
            cp,
            cs.recruitment
          );
          ...
          const pElPlus = elasticPressureAboveAOP(
            Math.min(vNew + epsV, vmax * (1 - 2 * EPS_CAP)),
            cp,
            cs.recruitment
          );
          const dpdV = (pElPlus - pEl) / epsV;
    ...
    function newtonStep(activeComps, vTrial, pBranch, boundary, params, dt) {
      ...
      for (iter = 0; iter < SOLVER_MAX_ITER; iter++) {
        ...
        if (norm < SOLVER_TOL_ABS || norm < SOLVER_TOL_REL * Math.max(initialNorm, 1e-12)) {
          converged = true;
          break;
        }
        const b = F.map((x) => -x);
    ...
    function finalize(activeComps, vTrial, pBranchSolved, state, boundary, params, dt, iterations, residualNorm, substeps) {
      const aop = params.airwayOpeningPressure;
...
// ards-twin-v0.4/src/ventilator/controller.js
var require_controller = __commonJS({
  "ards-twin-v0.4/src/ventilator/controller.js"(exports, module) {
...
// ards-twin-v0.4/src/contracts.js
var require_contracts = __commonJS({
  "ards-twin-v0.4/src/contracts.js"(exports, module) {
    ...
    function makeInitialState2(params, options = {}) {
      ...
      if (typeof options.initialPEEP === "number") {
        ...
        const compartments2 = params.compartments.map((cp) => {
          const a = recruitmentState && typeof recruitmentState[cp.id] === "number" ? clamp01(recruitmentState[cp.id]) : recruitmentDefaults[cp.id];
          const vmax = a * cp.capacity;
          let volume = 0;
          if (a > 0 && peep > aop) {
            volume = cp.capacity * (1 - Math.exp(-(peep - aop) / cp.elasticScale)) * a;
          }
        ...
        return {
          t: 0,
          compartments: compartments2,
          airwayPressure: peep,
          totalFlow: 0,
          totalVolume: compartments2.reduce((s, c) => s + c.volume, 0)
        };
      }
      if (typeof options.initialVolume === "number") {
        const initialVolume = options.initialVolume;
        const compartments2 = params.compartments.map((c) => {
          const v = initialVolume * c.fraction;
          const a = recruitmentState && typeof recruitmentState[c.id] === "number" ? clamp01(recruitmentState[c.id]) : recruitmentDefaults[c.id];
...
// ards-twin-v0.4/src/ventilator/vc_ac.js
var require_vc_ac = __commonJS({
  "ards-twin-v0.4/src/ventilator/vc_ac.js"(exports, module) {
...
// ards-twin-v0.4/src/ventilator/pc_ac.js
var require_pc_ac = __commonJS({
  "ards-twin-v0.4/src/ventilator/pc_ac.js"(exports, module) {
    var { BreathTracker, BreathPhase } = require_controller();
    var {
      makeBoundaryPressure: makeBoundaryPressure2,
      makeBoundaryFlow: makeBoundaryFlow2
...
// ards-twin-v0.4/src/gas_exchange.js
var require_gas_exchange = __commonJS({
  "ards-twin-v0.4/src/gas_exchange.js"(exports, module) {
...
// ards-twin-v0.4/src/metrics.js
var require_metrics = __commonJS({
  "ards-twin-v0.4/src/metrics.js"(exports, module) {
    ...
    function analyzeBreath2(trace, breathStartIdx, breathEndIdx) {
    ...
    function analyzeAll2(trace, setPEEP) {
      const metrics = [];
      ...
      for (let i = 0; i < expirStarts.length; i++) {
        ...
        const m = analyzeBreath2(trace, startIdx, endIdx);
        m.breathIndex = i;
    ...
    module.exports = { analyzeAll: analyzeAll2, analyzeBreath: analyzeBreath2, phaseSegments };
  }
});

// ards-twin-v0.4/src/simulation.js
var require_simulation = __commonJS({
  "ards-twin-v0.4/src/simulation.js"(exports, module) {
    ...
    var Simulation2 = class {
      ...
      metrics() {
        ...
        return analyzeAll2(this.trace, setPEEP);
      }
...
// ards-twin-v0.4/src/presets.js
var require_presets = __commonJS({
  "ards-twin-v0.4/src/presets.js"(exports, module) {
    var C0 = 0.12;
    var K_NORMAL = 30;
...
var export_analyzeAll = import_metrics.analyzeAll;
var export_analyzeBreath = import_metrics.analyzeBreath;
...
export {
  ...
  export_analyzeAll as analyzeAll,
  export_analyzeBreath as analyzeBreath,
