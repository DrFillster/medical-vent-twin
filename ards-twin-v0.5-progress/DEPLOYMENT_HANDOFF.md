...
Before publishing, from `ards-twin-v0.5-progress/` run locally:
...
Do **not** deploy `main` as the v0.6 Clinical Twin. Do **not** require GitHub Actions for deployment. Do **not** bundle HumMod.EXE or the upstream HumMod model tree.
